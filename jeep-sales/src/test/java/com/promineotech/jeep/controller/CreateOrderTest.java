...
class CreateOrderTest extends CreateOrderTestSupport {
	...
	void testCreateOrderReturnsSuccess201() {
		...
		int numRowsOrderOptions= JdbcTestUtils.countRowsInTable(jdbcTemplate, "order_options");
		...
		assertThat(JdbcTestUtils.countRowsInTable(jdbcTemplate, "order_options")).isEqualTo(numRowsOrderOptions+6);
	}	
}
